...
The second part of the script uses the raw LM coordinates directly into R/geomorph,aligns them with gpagen(), applies PCA, and builds the same allometric regression model and then compares it to the results obtained above. 
...
Due to arbitrary rotations, we cannot compare procrustes coordinates directly, instead we look centroid sizes, procD, PC scores, and allometric regression model summary geomorph does not report each sample's procD to the consensus shape
```{r}
